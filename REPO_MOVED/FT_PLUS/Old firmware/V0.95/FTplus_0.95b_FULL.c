...
int32 disp_checksum;
int8 mem_channel, PLLband, band, mem_mode, dcs, speed_dial, dhz, speed1, speed2, speed3, speed4, mic_pressed, res1, res2;
unsigned int8 status_flag;
...
start:
   ...
   //!      }
         ...
         if (!fine_tune) dialres = freq_dial_basic(frequency, speed1);
          ...
          if(dialres == 1) counterlimit = 3000;
