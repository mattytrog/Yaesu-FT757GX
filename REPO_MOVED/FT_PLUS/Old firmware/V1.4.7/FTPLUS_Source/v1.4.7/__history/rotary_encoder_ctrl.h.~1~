...
#define dial_timer_max 100 //max spin down-timer. All percentages are based of this. Default 40000
#define slow_speed_threshold 80
...
#define negative_pulse_sample_rate 15 //how often to check for negative pulse to fight against the decrement. Higher number means easier acceleration. Lower is harder (eg faster and harder). Default 50
...
#define dial_timer_pullback 3 //dial increment when negative (eg when slowing down spinning). How hard we fight against the decrement. Needs to be more than decrement. Default 20. Lower = acceleration increments kick in earlier
