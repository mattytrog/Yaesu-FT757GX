//Yaesu CPU firmware v0.9b (c)2025
...
#define out_speed3 10     //Faster still
#define out_speed4 20     //Super-fast
...
//set some flags
   ...
   //variables
   int32 hifreq, lofreq, tmpfreq1, tmpfreq2;
...
if(cb_region == 0)
      {
      if((tmp_cb_channel < 0) || (tmp_cb_channel > 39)) tmp_cb_channel = 0;
         limit = 39; start = 0;
      ...
      if(cb_region == 2)
      {
      if((tmp_cb_channel < 0) || (tmp_cb_channel > 79)) tmp_cb_channel = 0;
         limit = 79; start = 0;
         disp_cb_channel = tmp_cb_channel + 1;
      } 
