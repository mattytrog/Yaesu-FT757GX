...
//flicker-free increases display timing at the expense of a higher dial frequency increment 
//(ONLY APPLIES IN NON-ACCELERATED (STANDARD) DIAL! Accelerated dial and fine tuning are unaffected)...
//In flicker-free mode, each dial pulse counts 3, to make 10khz+ per dial revolution
//disabling "flicker-free" updates screen on every even cycle, with each dial pulse 
//equalling 2(1pos, 1neg) - yaesu spec, equalling exactly 10khz per dial revolution. More precise
//at the expense of 25-30khz refresh rate instead of 50-60.
//This has been done so all display chips are supported (TMS, PIC etc)
#define flicker_free 
...
#define display_interrupt_hold 10
...
unsigned int8 mem_channel, PLLband, band1, band2, band3, m_mode, dcs, speed_dial, mic_pressed, res1, res2, Q64_val, Q64_tmp, baud_rate_n;
int8 micres = 0, counter2 = 0, refresh_rate = 0;
