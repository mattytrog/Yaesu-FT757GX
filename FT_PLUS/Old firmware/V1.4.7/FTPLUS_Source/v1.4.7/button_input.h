...
void band_up(int8 value)
{
   switch(value)
   {
   case 1: IF(band1  == 9)band1 = 0; ELSE ++band1; save_band1(); break;
   case 2: IF(band2  == 9)band2 = 0; ELSE ++band2; save_band2(); break;
   }
}
...
void band_down(int8 value)
{
   switch(value)
   {
   case 1: IF(band1  == 0)band1 = 9; ELSE --band1; save_band1(); break;
   case 2: IF(band2  == 0)band2 = 9; ELSE --band2; save_band2(); break;
   }
}
...
cls();
//#fuses HS,PUT, NOWDT,NOPROTECT,NOLVP,BORV45
