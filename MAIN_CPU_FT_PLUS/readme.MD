...
!! DIFFERENT BOOTLOADERS WITH DIFFERENT SPEEDS AVAILABLE. DEFAULT FTPLUS_BOOTLOADER.HEX IS 9600 BAUD. ALL BOOTLOADERS IDENTICAL APART FROM SPEEDS... OTHERS ARE AVAILABLE ABOVE.  



![Alt text](https://github.com/mattytrog/Yaesu-FT757GX/blob/main/MAIN_CPU_FT_PLUS/readme.png?raw=true)
...
Switch rig off... Hold VFO A/B... Switch on to change modes. The rig will beep until it is power cycled. This changes between Yaesu and Kenwood modes. Default is Yaesu. Mode change complete.   


0.95b Changelog  

NAME: FTplus FT757GX version  
